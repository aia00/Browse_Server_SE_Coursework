...
import { useRevalidate } from '../utils/useGet';
...
export default (props: Props) => {
  ...
  >
    <div className=" flex h-full grow flex-col justify-between ">
      <TrashIcon
        className="absolute right-8 h-5 w-5 cursor-pointer text-primary"
    ...
    case 'light':
      ...
      return <>
        ...
        <div
          ...
          onClick={() => updateDevice({
            status: lightStatus,
            lightness: lightLightness === 100 ? 0 : (lightLightness || 0) + 50
          })}
        >
          {(lightLightness || 0)}%
          <div
